(module
 ...
 (data (i32.const 16504) "\04\00\00\00\08\00\00\00\03")
 (data (i32.const 16524) "\1c")
 (data (i32.const 16536) "\04\00\00\00\08\00\00\00\04")
 (data (i32.const 16556) "<")
 (data (i32.const 16568) "\01\00\00\00\"\00\00\00a\00s\00s\00e\00m\00b\00l\00y\00/\00u\00t\00i\00l\00s\00.\00t\00s")
 (table $0 5 funcref)
 ...
 (func $assembly/float/Randf64.poisson.cdf (param $0 f64) (param $1 f64) (result f64)
  ...
  block $assembly/specials/qgamma|inlined.0 (result f64)
   ...
   if (result f64)
    f64.const 1
    block $__inlined_func$assembly/specials/gser (result f64)
     f64.const 0
     local.get $0
     f64.const 0
     f64.le
     br_if $__inlined_func$assembly/specials/gser
     drop
     f64.const 1
     local.get $1
     local.tee $3
     ...
     loop $for-loop|0
      ...
      if
       ...
       if
        ...
        call $~lib/math/NativeMath.exp
        f64.mul
        br $__inlined_func$assembly/specials/gser
       end
       local.get $10
       i32.const 1
       i32.add
    ...
    block $__inlined_func$assembly/specials/gcf (result f64)
     local.get $1
     local.set $3
     f64.const 1
     local.set $9
      ...
      if
       ...
       if
        ...
        if
         ...
         call $~lib/math/NativeMath.exp
         f64.mul
         br $__inlined_func$assembly/specials/gcf
        end
        local.get $4
        local.set $2
       end
 ...
 (func $assembly/float/Randf64.poisson.quantile (param $0 f64) (param $1 f64) (result f64)
  ...
  f64.const nan:0x8000000000000
  local.set $1
  block $assembly/specials/quantile_approx|inlined.1
   i32.const 1
   local.get $0
   local.tee $3
   f64.const 1
   ...
   f64.lt
   select
   br_if $assembly/specials/quantile_approx|inlined.1
   f64.const 0
   local.set $1
   local.get $3
   f64.const 0
